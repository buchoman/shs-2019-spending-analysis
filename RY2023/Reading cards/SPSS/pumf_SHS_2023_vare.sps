VARIABLE LABELS
    ...
    WEIGHTD        "Weight for the diary file"
    PROV           "Province of residence"
    HHTYPE6        "Household type"
    HHSIZE         "Household size"
    P0TO4          "Presence of persons aged 0 to 4 years"
    P5TO15         "Presence of persons aged 5 to 15 years"
    P16TO29        "Presence of persons aged 16 to 29 years"
    P30TO64        "Presence of persons aged 30 to 64 years"
    P65TO74        "Presence of persons aged 65 to 74 years"
    P75PLUS        "Presence of persons aged 75 years"
    RP_AGEGP       "Reference person - Age group"
    RP_GEN         "Reference person - Gender"
    RP_MAST        "Reference person - Marital status"
    RP_EDUC        "Reference person - Education level"
    SPOUSEYN       "Presence of spouse"
    SP_AGEGP       "Spouse - Age group"
    SP_GEN         "Spouse - Gender"
    SP_EDUC        "Spouse - Education level"
    DWELTYP        "Type of dwelling occupied"
    TENURE         "Dwelling tenure"
    NUMBEDR        "Number of bedrooms"
    SECRES         "Ownership of secondary residence(s)"
    OTHPROP        "Ownership of other property"
    LANDLINE       "Household has landline telephone service"
    NUMCELL        "Number of cell phones"
    INTERNET       "Internet access"
    INTCON_H       "Type of Internet connection - High-speed telephone line"
    INTCON_C       "Type of Internet connection - Cable"
    INTCON_W       "Type of Internet connection - Wireless"
    INTCON_F       "Type of Internet connection - Fibre-optic"
    INTCON_O       "Type of Internet connection - Other"
    TVCON_C        "Household has cable television services"
    TVCON_S        "Household has television services via a satellite dish"
    TVCON_P        "Household has television services via a phone line"
    TVCON_F        "Household has television services via fibre-optic"
    TVCON_O        "Household has an other type of television service"
    OWNVEH         "Owned, leased or operated a vehicle"
    OWNRV          "Owned or operated a recreational vehicle"
    HHTOTINC       "Household - Total income"
    HHEMPIN        "Household - Employment income"
    HHINVST        "Household - Investment income"
    HHGTR          "Household - Government transfers"
    HHOTHINC       "Household - Other income"
    MAJINS         "Household - Major source of income"
    CC001          "Child care"
    ...
    CS021          "Telephones and other equipment"
    ...
    FD1100         "Ready-to-cook meal delivery services"
    ...
    FD478          "Ready-to-serve/cook prepared salads and side dishes, fruit/veg. based"
    ...
    FD899          "Canned, bottled and other infant food (including frozen)"
    ...
    HC002          "Direct costs to the household for health care"
    HC002_C        "Direct costs to the household for health care - Interview"
    HC002_D        "Direct costs to the household for health care - Diary"
    ...
    HE017          "Mainten./rental/repairs/serv. related to household furnishings/equip."
    ...
    HO003          "Pet expenses"
    HO052          "Pet food and pet-related goods"
    HO050          "Purchase of pets"
    ...
    ME040_C        "Other miscellaneous goods and services - Interview"
    ME040_D        "Other miscellaneous goods and services - Diary"
    ...
    RE031          "Recreational equipment and related services"
    RE031_C        "Recreational equipment and related services - Interview"
    RE031_D        "Recreational equipment and related services - Diary"
    ...
    RE074          "Package trips"
    RE091          "Use of recreational facilities and fees - other recreational activ."
    RE120          "Camcorders, cameras, parts, accessories and related equipment"
    RE125          "Sports, athletic and recreational equipment and related services"
    RE125_C        "Sports, athletic and rec. equipment and related services - Interview"
    RE125_D        "Sports, athletic and rec. equipment and related services - Diary"
    RE128          "Rental, maintenance/repairs of sports, athletic/recreational equipment"
    RE142          "Other recreational services"
    ...
    SH011          "Mortgage paid on the owned principal residence"
    ...
    SH030_A        "Water and sewage for principal accommodation"
    SH030_B        "Electricity for principal accommodation"
    SH030_C        "Natural gas for principal accommodation"
    SH034          "Other fuel for principal accommodation"
    SH040          "Other accommodation"
    SH041          "Owned secondary residences"
    SH042          "Mortgage paid on owned secondary residences"
    SH044          "Property insurance for owned secondary residences"
    SH046          "Other owned properties"
    SH047          "Other owned properties"
    SH050          "Accommodation away from home"
    SH060          "Communication and security services for owned secondary residences"
    SH061          "Property/school taxes, water/sewage charges for owned secondary res."
    SH062          "Electricity and fuel for owned secondary residences"
    SH082          "Repairs and maintenance of all owned principal residences"
    ...
    TA018_C        "Tobacco prod./alc. beverages/cannabis for non-medical use - Interview"
    TA018_D        "Tobacco prod./alc. beverages/cannabis for non-medical use - Diary"
    ...
    TR080_D        "Vehicle operations - Diary"
    TR080_C        "Vehicle operations - Interview"
