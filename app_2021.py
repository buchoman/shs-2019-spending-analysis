"""
Survey of Household Spending 2021 - Spending Analysis
...
# Year configuration
YEAR_CONFIG = YearConfig2021()

# Set page config
st.set_page_config(
    page_title="Survey of Household Spending 2021 - Spending Estimates",
    page_icon="💰",
    layout="wide"
)
...
ALLOCATION_INPUT_CACHE = Path("allocation_input_2021_latest.json")
...
@st.cache_data
def load_data():
    """Load the main dataset from fixed-width TXT (2021 PUMF)"""
    try:
...
def load_bootstrap_weights():
    """Load the bootstrap weights dataset from fixed-width TXT (2021 PUMF)"""
    try:
